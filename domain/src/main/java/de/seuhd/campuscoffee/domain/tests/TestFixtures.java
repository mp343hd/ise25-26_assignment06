...
public class TestFixtures {
    ...
    //DONE: Uncomment user-related test fixtures after implementing the user domain object and user service, add imports
   ...
   public static List<User> createUsers(UserService userService) {
    ...
    public static List<Pos> createFixtures(PosService posService) {
        return getPosFixturesForInsertion().stream()
                .map(posService::upsert)
                .collect(Collectors.toList());
    }
